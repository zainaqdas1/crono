<?php $title = 'Create new cronjob'; $active='new'; ?>

	      <div class="row">
	      	<div class="span12">      		
	      		<div class="widget ">
	      			<div class="widget-header"><i class="icon-star"></i><h3>New cronjob</h3></div>
								...
								<form id="edit-profile" class="form-horizontal" method="post">
									<fieldset>
                                        ...
                                        <div class="control-group">											
                                            ...
                                            <div class="controls">
												<label class="checkbox inline"><input type="checkbox" name="savelog" value="on" <?php echo  isset($_POST['savelog']) ? ' checked="checked"' : ''; ?> /> Check to save to the server</label>
											</div>
										</div>
                                        ...
                                        <div class="control-group">											
                                            ...
                                            <div class="controls">
												<label class="checkbox inline"><input type="checkbox" name="maillog" value="on" <?php echo  isset($_POST['maillog']) ? ' checked="checked"' : ''; ?> /> Mail log </label>
												<br />
